...
/**
 * Every color/spacing/radius here is a token reference (bg-primary,
 * rounded-md, ...) resolved from app/globals.css's @theme block — never
 * a literal value, per CLAUDE.md principle 6.
 */
